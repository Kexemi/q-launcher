...
assert.match(html, /state\.contradicted/);
assert.match(html, /record mismatch/);
assert.match(html, /proof_sources/);
assert.match(html, /portfolio-summary/);
assert.match(html, /S\.app\.portfolio/);
assert.match(html, /opportunity_cost_displacement/);
assert.match(html, /runtime_contradiction_count/);
